...
{ // If second arg specified, it is the test number to run
  ...
  String::ClearCounts();
  if (testNum < 0 || testNum == 1) { Test1(); String::PrintCounts();} //k
  if (testNum < 0 || testNum == 2) { Test2(); String::PrintCounts();} //k
  if (testNum < 0 || testNum == 3) { Test3(); String::PrintCounts();} //k
  if (testNum < 0 || testNum == 4) { Test4(); String::PrintCounts();} //k
  if (testNum < 0 || testNum == 5) { Test5(); String::PrintCounts();} //k
  if (testNum < 0 || testNum == 6) { Test6(); String::PrintCounts();} //k
#ifdef GRAD_STUDENT
